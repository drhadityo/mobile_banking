<?php
    ...
    include 'validasi/prosesTransfer.php';
?>
...
<head>
    ...
    <link rel="stylesheet" href="cusTranfer.css">
            ...
            <div class="konten">
                <div class="containerR">
                    <div class="mainkonten">
                        <div class="transfer">
                            <form action="<?php 'cusTranfer.php?no_rek='.$_GET['no_rek']; ?>" method="POST">
                                <label for="">No Rekening Tujuan</label><br>
                                <input type="text" name="rek_no_rek">
                                <span class="pesan_error"><?php echo $rekening_error; ?></span><br>

                                <label for="">Nominal</label><br>
                                <input type="text" name="jumlah">
                                <span class="pesan_error"><?php echo $jumlah_error; ?></span><br>

                                <label for="">Uraian</label><br>
                                <textarea name="keterangan"></textarea>
                                <span class="pesan_error"><?php echo $keterangan_err; ?></span><br>	
                                
                                <input class="submit" type="submit" name="submit" value="Transfer">
                                <span class="pesanError"><?php echo $form_error; ?></span>
                            </form>
                        </div>
                    </div>
                </div>

<?php
    ...
    $id = $_GET['username'];
    include 'validasi/validasiRek.php';
?>
...
<head>
    ...
    <title>Hubungkan Rekening</title>
            ...
            <div class="konten">
                <div class="containerR">
                    <div class="mainkonten">
                        <div class="editform">
                            <form action="<?php echo "adEREk.php?username=$id"; ?>" method = "POST">
                                <label for="">Masukkan Nomor Rekening :</label><br>
                                <input type="text" name="no_rek" placeholder="Masukan Nomor Rekening">
                                <?php echo $no_rek; ?>
                                <br>

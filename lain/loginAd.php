<?php
    include 'admin/crud/crud.php';
    if(isset($_POST['login'])){
        loginAdmin($_POST['username_admin'], $_POST['password']);
    }   
            ...
            <div class="konten">
                ...
                <div class="kontenR">
                    <form action="loginAd.php" method="POST">
                        <h2>Login...</h2>
                        <p>Sebagai <strong>ADMIN</strong></p>
                        ...
                        <input type="text" name="username_admin" id="inp" placeholder="Masukan Username..."><br>
                        <h1></h1>
